...
public class ProjectController {
  ...
  public ResponseEntity<Void> addNewProject(
      @Parameter(description = "Datos del nuevo proyecto", required = true) @RequestBody
          Project new_project)
      throws Exception {
  ...
  public ResponseEntity<Project> updateProject(
      @Parameter(description = "Datos actualizados del proyecto", required = true) @RequestBody
          Project project,
      @Parameter(description = "ID del proyecto a actualizar", required = true) @PathVariable
          int id) {
    try {
  ...
  @Operation(
      ...
      description = "Elimina un proyecto de la base de datos según el ID proporcionado.")
  public ResponseEntity<Void> deleteProject(
      @Parameter(description = "ID del proyecto a eliminar", required = true) @PathVariable
          int id) {
    try {
