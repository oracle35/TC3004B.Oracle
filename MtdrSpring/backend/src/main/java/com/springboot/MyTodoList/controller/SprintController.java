...
public class SprintController {
    ...
    public ResponseEntity<Sprint> getSprintById(
            @Parameter(description = "ID del sprint", required = true) @PathVariable int id) {
        try {
    ...
    @Operation(
            ...
            description =
                    "Crea un nuevo sprint con los datos enviados en el cuerpo de la solicitud.")
    public ResponseEntity<Void> addNewSprint(
            @Parameter(description = "Datos del nuevo sprint", required = true) @RequestBody
                    Sprint new_sprint)
            throws Exception {
    ...
    public ResponseEntity<Sprint> updateSprint(
            @Parameter(description = "Datos actualizados del sprint", required = true) @RequestBody
                    Sprint sprint,
            @Parameter(description = "ID del sprint a actualizar", required = true) @PathVariable
                    int id) {
        try {
    ...
    public ResponseEntity<Void> deleteSprint(
            @Parameter(description = "ID del sprint a eliminar", required = true) @PathVariable
                    int id) {
        try {
