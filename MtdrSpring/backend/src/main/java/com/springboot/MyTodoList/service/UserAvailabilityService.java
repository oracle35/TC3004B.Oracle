...
public class UserAvailabilityService {
    ...
    public ResponseEntity<UserAvailability> getUserAvailabilityById(int ID_User) {
        ...
        return userAvailability.map(availability -> new ResponseEntity<>(availability, HttpStatus.OK)).orElseGet(() -> new ResponseEntity<>(HttpStatus.NOT_FOUND));
    }

    public UserAvailability addUserAvailability(UserAvailability userAvailability) { return this.userAvailabilityRepository.save(userAvailability); }
