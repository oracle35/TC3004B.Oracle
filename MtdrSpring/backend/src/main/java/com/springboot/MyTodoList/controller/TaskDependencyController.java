...
public class TaskDependencyController {
    ...
    @PostMapping
    public ResponseEntity<TaskDependency> addNewTaskDependency(@RequestBody TaskDependency newDependency) throws Exception {
        ...
        return ResponseEntity
                ...
                .headers(headers)
                .body(createdDependency);
    }

    // Actualizar una dependencia de tarea
    @PutMapping("/{id}")
    public ResponseEntity<TaskDependency> updateTaskDependency(@RequestBody TaskDependency updatedDependency, @PathVariable int id) {
        try {
