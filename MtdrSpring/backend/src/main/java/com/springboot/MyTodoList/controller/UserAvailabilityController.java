...
@Tag(name="User Availability", description = "Operaciones CRUD para la tabla de Disponibilidad de Usuario")
public class UserAvailabilityController {
    @Autowired
    private UserAvailabilityService userAvailabilityService;

    @GetMapping
    public List<UserAvailability> getUserAvailability() { return userAvailabilityService.findAll(); }
