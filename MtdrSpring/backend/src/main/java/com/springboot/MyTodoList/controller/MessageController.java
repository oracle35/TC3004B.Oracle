...
public class MessageController {
  ...
  public ResponseEntity<Message> getMessageById(
      @Parameter(description = "ID del mensaje a buscar", required = true) @PathVariable int id) {
  ...
  public ResponseEntity<Message> updateMessage(
      @Parameter(description = "ID del mensaje a actualizar", required = true) @PathVariable int id,
  ...
  public ResponseEntity<Void> deleteMessage(
      @Parameter(description = "ID del mensaje a eliminar", required = true) @PathVariable int id) {
