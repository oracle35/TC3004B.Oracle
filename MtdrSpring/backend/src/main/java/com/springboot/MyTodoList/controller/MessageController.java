...
public class MessageController {
    ...
    public ResponseEntity<Message> createMessage(
            @Parameter(description = "Objeto Message que será creado", required = true)
    ...
    public ResponseEntity<Message> updateMessage(
            @Parameter(description = "ID del mensaje a actualizar", required = true)
            @PathVariable int id,
            @Parameter(description = "Datos actualizados del mensaje", required = true)
            @RequestBody Message message) {
